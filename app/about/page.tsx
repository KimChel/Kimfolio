    ...
    <div className="w-full h-full flex flex-col font-mono text-white p-2 overflow-hidden">
      <div className=" border-b-2 border-rose-500 flex justify-between items-end pb-2 ">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs">CONNECTION_ESTABLISHED_SUCCESFULLY</span>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-row pb-3 justify-between">
            <div className="w-[45%]">
              ...
              <input
                type="text"
                className="w-full border border-rose-500 focus:border-rose-500"
          ...
          <div className="pb-3">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-md border border-rose-500 py-3 px-6 text-base font-medium outline-none focus:border-rose-500"
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: `inset 0 0 20px ${
                    selectedCartridge === "skills" ? "#f59e0b" : "#000"
                  }`, // Inner glow
                }}
              >
                {renderContent()}
